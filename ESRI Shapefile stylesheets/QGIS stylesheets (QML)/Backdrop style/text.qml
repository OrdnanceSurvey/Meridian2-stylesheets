...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="CODE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="6500" label="6500"/>
      <category symbol="1" value="6552" label="6552"/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="TEXT_ANGLE"/>
    <edittype labelontop="0" editable="1" type="0" name="TEXT_SIZE"/>
  </edittypes>
  <editform>.</editform>
