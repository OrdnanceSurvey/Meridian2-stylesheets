...
<qgis version="2.12.0-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/BufferColor" value="1~~1~~CASE WHEN  &quot;CODE&quot; = '6500' THEN  color_rgb( 252, 252, 250 ) ELSE color_rgb( 255, 255, 255 ) END~~"/>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE WHEN  &quot;CODE&quot; = '6500' THEN  color_rgb( 0, 0, 0 ) ELSE color_rgb( 0, 154, 207 ) END~~"/>
