...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="CODE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="6403" label="District Boundary"/>
      <category symbol="1" value="6405" label="County Boundary"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="color" v="136,185,213,255"/>
